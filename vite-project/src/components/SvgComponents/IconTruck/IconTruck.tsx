...
export const IconTruck = () => {
  return (
    <IconTruckStyle>
      ...
      >
        <path
          d="M13.75 6.25H17.0781C17.2026 6.24919 17.3245 6.28606 17.4277 6.35578C17.5309 6.4255 17.6105 6.52479 17.6562 6.64062L18.75 9.375"
          stroke="#FF9601"
          strokeWidth="1.5"
          strokeLinecap="round"
        ...
        />
        <path
          d="M3.4375 15H1.875C1.70924 15 1.55027 14.9342 1.43306 14.8169C1.31585 14.6997 1.25 14.5408 1.25 14.375V5.625C1.25 5.45924 1.31585 5.30027 1.43306 5.18306C1.55027 5.06585 1.70924 5 1.875 5H13.75V13.375"
          stroke="#FF9601"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M13.75 9.375H18.75V14.375C18.75 14.5408 18.6842 14.6997 18.5669 14.8169C18.4497 14.9342 18.2908 15 18.125 15H16.5625"
          stroke="#FF9601"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
